...
$ins = @mysql_query("UPDATE uzytkownicy SET wybrane_auto='$car' WHERE nick='$nick'"); 
     
    if($ins) echo "Auto #1 dodane poprawnie. Dziękujemy za korzystanie z naszego systemu."; 
?>
	...
	<a href="system.php"><b><font color="black">>> Dodaj inne auta <<</font></b></a>
	</p>
</center>
